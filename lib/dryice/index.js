...
(function() {
    ...
    CommonJsProject.prototype.require = function(module) {
        ...
        this.roots.forEach(function(root) {
            ...
            } else if (i18nPluginPattern.test(module)) {
                baseObj = findModuleAt(baseObj, base, module.replace(i18nPluginPattern, ''));
                if (baseObj) {
                    baseObj.isI18n = true;
                }
            } else {
        ...
        if (!baseObj.isText && !baseObj.isI18n) {
