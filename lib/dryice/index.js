 ...
 */
function CommonJsProject(roots) {
    this.roots = roots;
    this.currentFiles = {};
    this.ignoredFiles = {};
};
(function() {
    CommonJsProject.prototype.assmeAllFilesLoaded = function() {
            ...
            'call': function(expr, args) {
                ...
                if (expr[1] === 'require') {
                    ...
                    if (args[0][0] === 'string') {
                        ...
                        console.log('Ignoring non-string require in ' +
                            baseObj.path);
                    }
                }
            }
...
copy.source.commonjs = function(obj) {
    if (!obj.project) {
        ...
        obj.project = new CommonJsProject({ unknown: obj.root });
    }
